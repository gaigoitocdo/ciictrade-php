<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/user/userlist.html";i:1759379658;s:61:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/head.html";i:1690299118;s:61:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/menu.html";i:1759377466;s:61:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/foot.html";i:1747648454;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<?php if(is_array($userinfo) || $userinfo instanceof \think\Collection || $userinfo instanceof \think\Paginator): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr>
        ...
        <td>
            ...
            <a href="<?php echo url('user/chongzhi',array('uid'=>$vo['uid'])); ?>">
                <button class="btn btn-warning btn-xs">Nạp tiền</button>
            </a>
