<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/chat/index.html";i:1759374088;s:61:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/head.html";i:1690299118;s:61:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/menu.html";i:1759377466;s:61:"/www/wwwroot/ibgold.dbvvn.com/application/lord/view/foot.html";i:1747648454;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<script>
 var conversationId = <?php echo isset($conversation['conversation_id']) ? $conversation['conversation_id'] : 0; ?>;
    ...
    $.post("<?php echo url('lord/Chat/getNewMessages'); ?>", {
        ...
        if (res.status == 1 && res.messages.length > 0) {
            res.messages.forEach(function(msg) {
                var isSent = msg.sender_id == uid || msg.sender_id == 0; 
                var senderName = msg.username ? msg.username : (msg.sender_id == 0 ? 'Admin' : 'User');
                ...
                $('#chat-box').append(
                    '<div class="message ' + (isSent ? 'sent' : 'received') + '" data-id="' + msg.message_id + '">' +
                        ...
                        '<br><small>' + formatTime(msg.sent_at) + '</small>' +
                    '</div>'
                );
